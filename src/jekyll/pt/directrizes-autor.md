...
Os autores devem consultar a [política de remoção das lições](/pt/licoes-politica-remocao) para obter informações sobre como a equipe editorial administra as lições que se tornam desatualizadas.
...
* [Faça o download do template de lição em português (.md).](/pt/licoes-modelo.md).
...
Para uma primeira introdução à formatação do Markdown, consultar [Introdução ao Markdown](/pt/licoes/introducao-ao-markdown), ou uma explicação mais breve em [Guia de Markdown do GitHub](https://guides.github.com/features/mastering-markdown/).
