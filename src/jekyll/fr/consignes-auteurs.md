...
<img src="/images/author-sm.png" class="garnish rounded float-left" />
...
Les auteur(e)s doivent consulter notre [politique de retrait des leçons](/fr/politique-retrait-lecons), qui décrit comment l'équipe éditoriale du *Programming Historian en français* gère les leçons qui sont devenues obsolètes. 
...
### Écrire en Markdown 
Toutes les leçons doivent être écrites en [Markdown](https://fr.wikipedia.org/wiki/Markdown). Nous fournissons [un modèle que vous pouvez utiliser pour écrire votre leçon](/fr/modele-tuto.md).  
