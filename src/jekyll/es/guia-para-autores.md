...
Consulta nuestra [política de retirada de lecciones](/es/politica-retirada-lecciones) para información sobre cómo el equipo editorial maneja las lecciones que se han vuelto obsoletas.
...
* [Descarga la plantilla para lecciones en español (.md)](/es/plantilla-leccion.md).
...
Para una introducción sencilla a Markdown puedes ver la lección [Introducción a Markdown](/es/lecciones/introduccion-a-markdown) o la referencia concisa [GitHub Guide to Markdown](https://help.github.com/es/github/writing-on-github/basic-writing-and-formatting-syntax).
